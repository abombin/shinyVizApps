                 ...
                 tabsetPanel(
                   tabPanel("Phylogeny", fluid=T,
                            fluidPage(
                              ...
                              splitLayout(cellWidths=c("35%", "35%", "15%"), textInput(inputId = "optionB", label= "Filter"), 
                                          textInput(inputId = "treeRoot", label= "Root"), actionButton(inputId ="goRoot", "Root")),
                              br(),
                              br(),
                              br(),
                              mainPanel(
...
server <- function(input, output) {
  ...
  selTree<- reactive({
    ...
    selTree1<-ape::keep.tip(data, tip=selTips)
    selTree1
